...
questions = [
  ...
  "Today on Buzzfeed: 10 Pictures of ______ That Look Like __________!",
  "Why am I so tired?",
  "Honey, Mommy and Daddy love you very much. But apparently Mommy loves _______ more than she loves Daddy.",
...
answers = [
  ...
  "AIDS.",
  "Alcoholism.",
  "All of the poop inside my body.",
  "All of this blood.",
...
module.exports = (robot) ->
  robot.respond /card(?: me)?(?: )(\d+)?/i, (msg) ->
    answers.push msg.message.user.name #add the requesting user as a card. 
